      ...
      <div class="box box-content">
        <div class="box-body">
            ...
            <div>
              ...
              <form action="<?php echo e(url('seminar')); ?>" enctype="multipart/form-data" name="filterData"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2" style='text-align:right'>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="btn-group">
                                    <a href="<?php echo e(url('laporan/create')); ?>" class="btn btn-info"> <i
                                            class="fa fa-plus"></i>
                                        Tambah</a>
                ...
                <table id="data-tables" class="table table-striped table-bordered dataTable customTable" cellspacing="0" width="100%">
                    ...
                    <tbody>
                     ...
                     <tr>
                         ...
                         <td><?php echo e($key->bu_r ? $key->bu_r->nama_bu : ''); ?></td>
                         <td><?php echo e($key->iso_r->kode); ?></td>
                         <td><?php echo e($key->id_number); ?></td>
                         <td><?php echo e($key->audit_date); ?></td>
                         <td align='center'>
                            <?php if($key->status == 1): ?>
...
<div class="modal fade" id="modal-konfirmasi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <form action="<?php echo e(url('laporan/destroy')); ?>" class="form-horizontal" id="formDelete" name="formDelete"
...
$(function(){
  ...
  $('#btnHapus').on('click', function (e) {
    ...
    $('#btnEdit').on('click', function (e) {
        ...
        url = id[0];
        window.location.href = "<?php echo e(url('laporan')); ?>/" + url + "/edit";
        }
    });
    ...
    $('#printIso').on('click', function (e) {
            ...
            if (id.length == 0) {
                ...
                url = id[0];
                window.open("<?php echo e(url('laporan/print')); ?>/" + url,'_blank');
            }
        });
