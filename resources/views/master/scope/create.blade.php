                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="kode" id="kode" type="text" class="form-control" placeholder="Kode Scope">
                                <span id="kode" class="help-block" >{{ $errors->first('kode') }} </span> 
                            </div>

                            <div class="form-group">
                                <label>Nama Indonesia<span style="color: red;">*</span> </label>
                                <input name="nama_id" id="nama_id" type="text" class="form-control" placeholder="Nama Indonesia">
                                <span id="nama_id" class="help-block" >{{ $errors->first('nama_id') }} </span> 
                            </div>

                            <div class="form-group">
                                <label>Nama Inggris<span style="color: red;">*</span></label>
                                <input name="nama_en" id="nama_en" type="text" class="form-control" placeholder="Nama Inggris">
