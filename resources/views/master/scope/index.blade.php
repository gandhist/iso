    ...
    <section class="content">
      ...
      <div class="box box-content">
        <div class="box-body">
            ...
            <div>
              {{-- form filter --}}
              {{-- <form  enctype="multipart/form-data" name="filterData"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2" style='text-align:right'>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="btn-group">
                                    <a href="{{ url('master/scope/create') }}" class="btn btn-info"> <i
                                            class="fa fa-plus"></i>
                                        Tambah</a>
...
<div class="modal fade" id="modal-konfirmasi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <form action="{{ url('master/scope/destroy') }}" class="form-horizontal" id="formDelete" name="formDelete"
...
$(function(){
  ...
  $('#btnHapus').on('click', function (e) {
    ...
    $('#btnEdit').on('click', function (e) {
        ...
        url = id[0];
        window.location.href = "{{ url('master/scope') }}/" + url + "/edit";
        }
    });
