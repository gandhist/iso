                    ...
                    <div align=center >
                        <div style="text-align: justify;">
                            ...
                            <ol type="1">
                                ...
                                <input {{ $data->tas_3 == 'tangguh' ? "checked='checked'" : '' }} type="checkbox"> Ditangguhkan sampai tindakan korektif yang memuaskan<br>
                            ...
                            <ol type="1" start="4">
                                <li><b>Hasil Audit Sebelumnya (N/A)</b></li>
                                    ...
                                    <table border=0 width=95%>
                                        <tr>
                                            <td width=5% style="vertical-align:top; padding:5px;"><input {{ $data->audit_sebelumnya == '1' ? "checked='checked'" : '' }} type="checkbox"></td>
                                        ...
                                        <tr>
                                            <td width=5% style="vertical-align:top; padding:5px;"><input {{ $data->audit_sebelumnya == '2' ? "checked='checked'" : '' }} type="checkbox"></td>
                                        ...
                                        <tr>
                                            <td width=5% style="vertical-align:top; padding:5px;"><input {{ $data->audit_sebelumnya == '3' ? "checked='checked'" : '' }} type="checkbox"></td>
                                ...
                                <li><b>Temuan Audit</b></li>
                                    ...
                                    <table border=1 width=95% cellspacing=0 cellpadding=0 style="border-collapse:collapse; border:1;">
                                        <tr>
                                            ...
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_1 == '1' ? "checked='checked'" : '' }} type="checkbox"><br>Yes</td>
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_1 == '0' ? "checked='checked'" : '' }} type="checkbox"><br>No</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_2 == '1' ? "checked='checked'" : '' }} type="checkbox"><br>Yes</td>
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_2 == '0' ? "checked='checked'" : '' }} type="checkbox"><br>No</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_3 == '1' ? "checked='checked'" : '' }} type="checkbox"><br>Yes</td>
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_3 == '0' ? "checked='checked'" : '' }} type="checkbox"><br>No</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_4 == '1' ? "checked='checked'" : '' }} type="checkbox"><br>Yes</td>
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_4 == '0' ? "checked='checked'" : '' }} type="checkbox"><br>No</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_5 == '1' ? "checked='checked'" : '' }} type="checkbox"><br>Yes</td>
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_5 == '0' ? "checked='checked'" : '' }} type="checkbox"><br>No</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_6 == '1' ? "checked='checked'" : '' }} type="checkbox"><br>Yes</td>
                                            <td width=10% style="text-align:center; vertical-align:middle; padding:5px;"><input {{ $data->ta_6 == '0' ? "checked='checked'" : '' }} type="checkbox"><br>No</td>
                                        </tr>
                        ...
                        <div style="text-align: justify;">
                            ...
                            <ol type="1" start="6">
                                ...
                                <li><b>Ketidaksesuaian</b></li>
                                    ...
                                    <table border=1 width=95% cellspacing=0 cellpadding=0 style="border-collapse:collapse; border:1;">
                                        <tr>
                                            <td width=5% style="vertical-align:top; padding:10px;"><input {{ $data->tikor == 'major' ? "checked='checked'" : '' }} type="checkbox"></td>
                                        ...
                                        <tr>
                                            <td width=5% style="vertical-align:top; padding:10px;"><input {{ $data->tikor == 'minor' ? "checked='checked'" : '' }} type="checkbox"></td>
                        ...
                        <table width=100% border=1 cellspacing=0 cellpadding=0 style=" border-collapse:collapse;border:0;">
                            <tr>
                                ...
                                <td colspan="6" style="vertical-align: top; padding:5px; font-weight: bold;">
                                    <span id="nama_perusahaan" contenteditable="true" placeholder="Nama Perusahaan" style="text-transform: uppercase;">{{ $data->bu_r->nama_bu }}</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="width:25%; vertical-align:top; padding: 5px;"><span id="auditors" contenteditable="true" placeholder=". . . . . . . .">{{ $data->lead_auditor }} & {{ $data->additional_member }} </span></td>
                                <td colspan="2" style="width:25%; vertical-align:top; padding: 5px;">Date(s) of audit(s)</td>
                                <td colspan="2" style="width:25%; vertical-align:top; padding: 5px;"><span id="aud_date" contenteditable="true" placeholder="DD-MM-YYYY">{{ $data->audit_date ? \Carbon\Carbon::parse($data->audit_date)->isoFormat('DD MMMM YYYY') : ''}}</span></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="vertical-align: top; padding:5px;">Standard(s)</td>
                                <td colspan="6" style="vertical-align: top; padding:5px;">
                                    <span id="id_iso" contenteditable="true" placeholder=". . . . . . . .">{{ $data->iso_r->kode }}</span>
                                </td>
                            </tr>
                            ...
                            {{-- <tr>
                                ...
                                <td colspan="4" style="width:50%; vertical-align:top; padding: 5px;"><span id="id_iso" contenteditable="true" placeholder=". . . . . . . .">{{ $data->iso_r->kode }}</span></td>
                            </tr> --}}
                            
                            {{-- <tr>
                                <td colspan="4" style="vertical-align:top; padding: 5px;">Organization Rep.</td>
                                <td colspan="4" style="vertical-align:top; padding: 5px;"><span id="comp_rep" contenteditable="true" placeholder=". . . . . . . .">{{ $data->or1 }}</span></td>
                            </tr> --}}
                            
                            <tr>
                                <td colspan="4" style="vertical-align:top; padding: 5px;">Area/Department/Process</td>
                                <td colspan="4" style="vertical-align:top; padding: 5px;"><span id="area" contenteditable="true" placeholder=". . . . . . . .">{{ $data->dept }}</span></td>
                            </tr>
                            
                            <tr>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">Document Ref.</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="doc_reff" contenteditable="true" placeholder=". . . . . . . .">{{ $data->doc_ref }}</span></td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">Standard Ref.</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="std_reff" contenteditable="true" placeholder=". . . . . . . .">{{ $data->standard_ref }}</span></td>
                                
                            <tr>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">No. CAR</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="car_no" contenteditable="true" placeholder=". . . . . . . .">{{ $data->car_no }}</span></td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">CAR Close-Out date</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="co_date" contenteditable="true" placeholder="DD-MM-YYYY">{{ $data->car_date ? \Carbon\Carbon::parse($data->car_date)->isoFormat('DD MMMM YYYY') : '' }}</span></td>
                            </tr>
                            
                            <tr>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">Detail of Non-Conformity</td>
                                <td colspan="6" style="vertical-align:top; padding: 5px;"><span id="det_non_conf" contenteditable="true" placeholder=". . . . . . . .">{{ $data->doc_r->nama }}</span></td>
                            </tr>
                            
                            <tr>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">Organization Rep.</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="comp_rep" contenteditable="true" placeholder=". . . . . . . .">{{ $data->or2 }}</span></td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">Auditor</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="auditors" contenteditable="true" placeholder=". . . . . . . .">{{ $data->auditor1 }}</span></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">Organization Rep.</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="org_rep" contenteditable="true" placeholder=". . . . . . . . . .">{{ $data->or3 }}</span></td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">Date</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="org_rep_date" contenteditable="true" placeholder="DD-MM-YYYY">{{ $data->date_or ? \Carbon\Carbon::parse($data->date_or)->isoFormat('DD MMMM YYYY') : '' }}</span></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">Auditor</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="auditor" contenteditable="true" placeholder=". . . . . . . .">{{ $data->auditor2 }}</span></td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;">Date</td>
                                <td colspan="2" style="vertical-align:top; padding: 5px;"><span id="aud_date" contenteditable="true" placeholder="DD-MM-YYYY">{{ $data->auditor_date ? \Carbon\Carbon::parse($data->auditor_date)->isoFormat('DD MMMM YYYY') : '' }}</span></td>
                            </tr>
